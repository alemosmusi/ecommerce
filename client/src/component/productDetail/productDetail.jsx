...
<div>
        ...
        <div className="card-header border-0 bg-white p-0">
            ...
            <div className="label-top shadow-sm text-white">{details.brand_name}</div>
                    ...
                    <div className="col-md-9 abc ">
                     <h1><u className='display-4'>{details.name}</u></h1>
                     </div>
 ...
 <div className='dropdown'>
          <button className="btn btn-secondary dropdown-toggle" href="#"  role="button" data-bs-toggle="dropdown" aria-expanded="false">
           TALLES
          </button>
          <ul className="dropdown-menu"  aria-labelledby="navbarDropdown">

                    {details.size_range.length ? details.size_range.map((e,i)=>{
                            return(
                            <div>
                            <input type="checkbox" className="checkbox" id={i} autocomplete="off"/>
                            <label className="form-check-label" for={e}>{e}</label>
                            </div>
                            )
                        })
                        : <div> </div>
            ...
            <li><a className="dropdown-item" href="#">algo mas</a></li> */}
                 ...
                 <ul className="list-group list-group-light list-group-small">
                     <li className="list-group border-0 text-start "><strong>DESCRIPCION: <small className='fst-normal'>{details.details}</small></strong></li>
                     <li className="list-group border-0 text-start"><strong>DESIGNER: <small className='fst-normal'>{details.designer}</small></strong></li>
                     ...
                     <li className="list-group border-0 text-start"><strong>COLOR: <small className='fst-normal'>{details.color}</small></strong></li>
                     <li className="list-group border-0 text-start"><strong>RELEASED: <small className='fst-normal'>{details.released}</small></strong></li>
                     <li className="list-group border-0 text-start"><strong>CATEGORIE: <small className='fst-normal'>{details.categories[0]}</small></strong></li>
                     <li className="list-group border-0 text-start"><strong>GENDER: <small className='fst-normal'>{details.gender[0]}</small></strong></li>
                 </ul>
             </div>
        {/* </div> */}
