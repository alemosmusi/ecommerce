...
<footer className="text-center text-lg-start bg-light text-muted">
  ...
  >
    ...
    <div>
      ...
      <a href="https://www.linkedin.com/company/dafiti-group-latam/?originalSubdomain=ar" className="me-4 text-reset">
    ...
    <div className="container text-center text-md-start mt-5">
      <div className="row mt-3">
        ...
        <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
          <Link to='/terms' className='text-dark'>Terms</Link>
          </p>
          <p>
  ...
  <div className="text-center p-4" >
    © 2022 Copyright:
    <Link to='/copyright' className='text-reset fw-bold'>ALUMNOSHENRY</Link>
  </div>
</footer>
  )
}